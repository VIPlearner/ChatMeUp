...
public final class ColorKt {
    ...
    private static final long cmuOffWhite = 0L;
    private static final long cmuBlue = 0L;
    private static final long cmuDarkBlue = 0L;
    private static final long cmuLightGrey = 0L;
    private static final long cmuDarkGrey = 0L;
    private static final long cmuGrey = 0L;
    ...
    private static final long neutral_dark = 0L;
    private static final long neutral_disabled = 0L;
    private static final long success_green = 0L;
    private static final long brand_color = 0L;
    ...
    public static final long getCmuOffWhite() {
        return 0L;
    }
    
    public static final long getCmuBlue() {
        return 0L;
    }
    
    public static final long getCmuDarkBlue() {
        return 0L;
    }
    
    public static final long getCmuLightGrey() {
        return 0L;
    }
    
    public static final long getCmuDarkGrey() {
        return 0L;
    }
    
    public static final long getCmuGrey() {
        return 0L;
    }
    ...
    public static final long getNeutral_dark() {
        return 0L;
    }
    
    public static final long getNeutral_disabled() {
        return 0L;
    }
    
    public static final long getSuccess_green() {
        return 0L;
    }
    
    public static final long getBrand_color() {
        return 0L;
    }
